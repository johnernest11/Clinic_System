...
include "assets/medical_profile_query.php";
?>
<main>
    <style type="text/css">
      #logo {
                ...
                <img src="../PICTURE/DMMMSULogo.png" id="logo" width="150" height="80">
                  ...
                  <br>
                    ...
                    <br>
                            ...
                            <input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="form1" name="Medication1"  class="form-control" value=" ">
                            <fieldset class="form-check">
