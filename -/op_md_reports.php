...
<div class="card-body">
    <div class="table-responsive">
        ...
        <div class="col-2">
            <form action="fpdf/Out_Patient_Reports.php"  method='POST' target='_blank'>
        ...
        <div class="col-2">
            <a name="filter" id="filter" value="" class="btn btn-info btn-sm"><i class=" fas fa-search" aria-hidden="true"></i> </a>
...
<script>  
      $(document).ready(function(){  
           $('#filter').click(function(){  
                ...
                {  
                     $.ajax({  
                          url:"assets/out_patient_filter.php",  
                          method:"POST",  
