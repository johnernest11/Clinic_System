...
<!-- Page Heading -->
<br>
<h1 class="h3 mb-2 text-gray-800"> <i class=" fas fa-search" aria-hidden="true"></i> SEARCH STUDENTS ID NO.</h1>
...
<div class="card shadow mb-4 ">
    ...
    <div class="table-responsive">
        ...
        <div class="col-3">
        <h6>Student ID No.</h6>
    <input type="text" class="form-control" id="search" data-inputmask="'mask': '999-9999-9' ">
        </div>
        </div>
