<?php
 ...
 require_once "../assets/medical_fpdf.php";
include 'fpdf.php';   
// Include the PDF class
// Create instance of PDF class
//$pdf = new FPDF();
$pdf = new FPDF('P', 'mm', 'legal');
$pdf->SetTitle("$last_name- Medical Record");
...
$pdf->Cell(12);
$pdf->Cell(50,6, "$last_name",0,0);
$pdf->Cell(54,6, "$first_name",0,);
$pdf->Cell(25,6, "$mid_name",0,1);
//
