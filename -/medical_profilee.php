                ...
                <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                  ...
                  <br>
                    ...
                    <div class="form-row">
                             ...
                             <input type="hidden"  class="form-control" id="validationCustom01" name="pe_id" value="<?php echo$pe_id;?>" >
                             <div class="col-md-2">
                                <p><b>NAME:</b></p>
                    ...
                    <div class="col-md-6">
                            ...
                            <br>
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Mumps" name="Mumps" value="Yes" <?php echo$Mumps =='Yes' ? 'checked' : '';?> onclick="return false; ">
                            <label class="form-check-label" for="Mumps"><h6><b>8. Mumps</b></h6> </label>
                            </fieldset>
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Measles" name="Measles" value="Yes" <?php echo$Measles =='Yes' ? 'checked' : '';?> onclick="return false; ">
                            <label class="form-check-label" for="Measles"><h6><b>9. Measles</b></h6></label>
                            </fieldset>
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Chicken_Pox" name="Chicken_Pox" value="Yes" <?php echo$Chicken_Pox =='Yes' ? 'checked' : '';?> onclick="return false; ">
                            <label class="form-check-label" for="Chicken_Pox"><h6><b>10. Chicken Pox</b></h6></label>
                            </fieldset>
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Tuberculosis" name="Tuberculosis" value="Yes" <?php echo$Tuberculosis =='Yes' ? 'checked' : '';?> onclick="return false; ">
                            <label class="form-check-label" for="Tuberculosis"><h6><b>11. Tuberculosis</b></h6></label>
                            </fieldset>
                            <div class="input-group">
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Other" name="Other" value="Yes" <?php echo$Other =='Yes' ? 'checked' : '';?> onclick="return false; ">
                    ...
                    <br>
                            ...
                            <input class="form-check-input" type="checkbox" id="Accident_operationYes" name="Accident_operation[]" value="Yes" <?php echo$Accident_operation =='Yes' ? 'checked' : '';?> onclick="return false;">
                            <label class="form-check-label" for="Accident_operationYes"><h6><b>Yes</b></h6> </label>
                            <input class="form-check-input" type="checkbox" id="Accident_operationNo" name="Accident_operation[]" value="No" <?php echo$Accident_operation =='No' ? 'checked' : '';?> onclick="return false;">
                            ...
                            <input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="form1" name="Medication"  class="form-control" value="<?php echo$Medication;?>" disabled>
                            <fieldset class="form-check">
                    ...
                    <br>
                            ...
                            <input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="form1" name="BBP"  class="form-control" value="<?php echo$BP;?>" disabled>
                            <fieldset class="form-check">
                    ...
                    <?php
                            ...
                            ?>
                                ...
                                <!-- MODAL -->
                                <div class="modal fade" id="UpdateRemarks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger" type="button" data-dismiss="modal">No</button>
                     <button type="submit" class="btn btn-primary"  name="UpdateRemarks"  > Yes</button>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <form action="fpdf/Medical.php" method="POST" target='_blank'>
                    <div class="form-row">
                    <div class="col-lg-6 ">
                    </div>
