...
<head>
    ...
    <link rel = "icon" href = "PICTURE/clinic.png" type = "image/x-icon" class="img-fluid">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <img src="PICTURE/clinic.png"class="rounded mx-auto d-block position-static" width="110%"  ></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">DMMMMSU-MLUC MEDICAL RECORDS</h1>
                                    </div>
